...
<details>
  ...
  | Screenshot              |  Tools Used | Hosting | Project Repository |
|-------------------------|-------------|---------|--------------------|
| <img src="https://github.com/user-attachments/assets/243ecbdc-f79d-47d8-ac33-d2e64bf5e4ea" alt="File Organizer" height="450" width="450">  | Python,Selenium, | Netlify,Github,Vercel `(Hosting)` | [``Live Preview``](https://github.com/FKdevelopers254/File-Organizer) |
